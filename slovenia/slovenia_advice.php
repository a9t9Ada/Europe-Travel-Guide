<?php
	include_once "includes/slovenia_advice_script.php";
?>
<!DOCTYPE html>
<html lang = "en">
<head>
	...
	<link rel = "stylesheet" href = "../css/style_slovenia.css">
	<link rel = "icon" type = "image/icon" href = "../icon1.png">
	
	<meta charset = "UTF-8">
	<meta name = "keywords" content = "Slovenia, food, fun, enjoy">
	<meta name = "description" content = "Tip and tricks about vacation in Slovenia">
...
<body>
	<header class = "header header_image">
		 <img src="images_slovenia/slovenia_flag.jpg" alt="Slovenia Flag">
	...
	<nav class = "nav">
		<ul>
			...
			<li> <a href = "slovenia_monuments.html">Monuments </a></li>
			<li> <a href = "slovenia_food.html">Food </a></li>
			<li> <a href = "slovenia_trip.html">Trip plan </a></li>
			<li><a href = "slovenia_advice.php" class = "active"> Advice </a></li>
	...
	<?php if (isset($_POST["addComm"])){
		if (isset($_COOKIE["user"]) || isset($_SESSION["user"]) || isset($_SESSION["userID"]) || isset($_COOKIE["userID"])){
			...
			echo "<a href = 'slovenia_logIn.php' class = 'logIn' >LogIn</a>";
			echo "<a href = 'slovenia_signUp.php' class = 'logIn'>SignUp</a><br>";
		}
	}
	 ?>
	</section>
