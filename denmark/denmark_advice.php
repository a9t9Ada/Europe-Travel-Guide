<?php
	include_once "includes/denmark_advice_script.php";
?>
<!DOCTYPE html>
<html lang = "en">
<head>
	...
	<link rel = "stylesheet" href = "../css/style_denmark.css">
	<link rel = "icon" type = "image/icon" href = "../icon1.png">
	
	<meta charset = "UTF-8">
	<meta name = "keywords" content = "Denmark, food, fun, enjoy">
	<meta name = "description" content = "Tip and tricks about vacation in Denmark">
...
<body>
	<header class = "header header_image">
		 <img src="images_denmark/denmark_flag.png" alt="Denmark Flag">
	...
	<nav class = "nav">
		<ul>
			...
			<li> <a href = "denmark_monuments.html">Monuments </a></li>
			<li> <a href = "denmark_food.html">Food </a></li>
			<li> <a href = "denmark_trip.html">Trip plan </a></li>
			<li><a href = "denmark_advice.php" class = "active"> Advice </a></li>
	...
	<?php if (isset($_POST["addComm"])){
		if (isset($_COOKIE["user"]) || isset($_SESSION["user"]) || isset($_SESSION["userID"]) || isset($_COOKIE["userID"])){
			...
			echo "<a href = 'denmark_logIn.php' class = 'logIn' >LogIn</a>";
			echo "<a href = 'denmark_signUp.php' class = 'logIn'>SignUp</a><br>";
		}
	}
	 ?>
	</section>
