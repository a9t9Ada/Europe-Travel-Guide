<?php
	include_once "includes/austria_advice_script.php";
?>
<!DOCTYPE html>
<html lang = "en">
<head>
	...
	<link rel = "stylesheet" href = "../css/style_austria.css">
	<link rel = "icon" type = "image/icon" href = "../icon1.png">
	
	<meta charset = "UTF-8">
	<meta name = "keywords" content = "Austria, food, experience, enjoy">
	<meta name = "description" content = "Tip and tricks about vacation in Austria">
...
<body>
	<header class = "header header_image">
		 <img src="images_austria/austria_flag.jpg" alt="Austria Flag">
	...
	<nav class = "nav">
		<ul>
			...
			<li> <a href = "austria_monuments.html">Monuments </a></li>
			<li> <a href = "austria_food.html">Food </a></li>
			<li> <a href = "austria_trip.html">Trip plan </a></li>
			<li><a href = "austria_advice.php" class = "active"> Advice </a></li>
	...
	<?php if (isset($_POST["addComm"])){
		if (isset($_COOKIE["user"]) || isset($_SESSION["user"]) || isset($_SESSION["userID"]) || isset($_COOKIE["userID"])){
			...
			echo "<a href = 'austria_logIn.php' class = 'logIn' >LogIn</a>";
			echo "<a href = 'austria_signUp.php' class = 'logIn'>SignUp</a><br>";
		}
	}
	 ?>
	</section>
