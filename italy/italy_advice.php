<?php
	include_once "includes/italy_advice_script.php";
?>
<!DOCTYPE html>
<html lang = "en">
...
<head>
	...
	<link rel = "stylesheet" href = "../css/style_italy.css">
	<link rel = "icon" type = "image/icon" href = "../icon1.png">
	
	<meta charset = "UTF-8">
	<meta name = "keywords" content = "Italy, food, fun, enjoy">
	<meta name = "description" content = "Tip and tricks about vacation in Italy">
...
<body>
	...
	<ul>
		...
		<li><a href = "italy_monuments.html">Monuments </a></li>
		<li><a href = "italy_food.html">Food </a></li>
		<li><a href = "italy_trip.html">Trip plan </a></li>
		<li><a href = "italy_advice.php" class = "active"> Advice </a></li>
	...
	<?php if (isset($_POST["addComm"])){
		if (isset($_COOKIE["user"]) || isset($_SESSION["user"]) || isset($_SESSION["userID"]) || isset($_COOKIE["userID"])){
			...
			echo "<a href = 'italy_logIn.php' class = 'logIn' >LogIn</a>";
			echo "<a href = 'italy_signUp.php' class = 'logIn' >SignUp</a><br>";
		}
	}
	 ?>
	</section>
