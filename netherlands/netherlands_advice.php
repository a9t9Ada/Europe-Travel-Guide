<?php
	include_once "includes/netherlands_advice_script.php";
?>
<!DOCTYPE html>
<html lang = "en">
<head>
	...
	<meta charset = "UTF-8">
	<meta name = "keywords" content = "Netherlands, food, fun, enjoy">
	<meta name = "description" content = "Tip and tricks about vacation in Netherlands">
...
<body>
	...
	<nav class = "nav">
		<ul>
			...
			<li><a href = "netherlands_advice.php" class = "active"> Advice </a></li>
	...
	<?php if (isset($_POST["addComm"])){
		if (isset($_COOKIE["user"]) || isset($_SESSION["user"]) || isset($_SESSION["userID"]) || isset($_COOKIE["userID"])){
			...
			echo "<a href = 'netherlands_logIn.php' class = 'logIn' >LogIn</a>";
			echo "<a href = 'netherlands_signUp.php' class = 'logIn' >SignUp</a><br>";
		}
	}
	 ?>
	</section>
