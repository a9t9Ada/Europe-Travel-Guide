<?php
	include_once "includes/serbia_advice_script.php";
?>
<!DOCTYPE html>
<html lang = "en">
<head>
	...
	<link rel = "stylesheet" href = "../css/style_serbia.css">
	<link rel = "icon" type = "image/icon" href = "../icon1.png">
	
	<meta charset = "UTF-8">
	<meta name = "keywords" content = "Serbia, food, fun, enjoy">
	<meta name = "description" content = "Tip and tricks about vacation in Serbia">
...
<body>
	<header class = "header header_image">
		 <img src="images_serbia/serbia_flag.png" alt="Serbia Flag">
	...
	<nav class = "nav">
		<ul>
			...
			<li> <a href = "serbia_monuments.html">Monuments </a></li>
			<li> <a href = "serbia_food.html">Food </a></li>
			<li> <a href = "serbia_trip.html">Trip plan </a></li>
			<li><a href = "serbia_advice.php" class = "active"> Advice </a></li>
	...
	<?php if (isset($_POST["addComm"])){
		if (isset($_COOKIE["user"]) || isset($_SESSION["user"]) || isset($_SESSION["userID"]) || isset($_COOKIE["userID"])){
			...
			echo "<a href = 'serbia_logIn.php' class = 'logIn' >LogIn</a>";
			echo "<a href = 'serbia_signUp.php' class = 'logIn' >SignUp</a><br>";
		}
	}
	 ?>
	</section>
