<?php
	include_once "includes/france_advice_script.php";
?>
<!DOCTYPE html>
<html lang = "en">
<head>
	...
	<meta charset = "UTF-8">
	<meta name = "keywords" content = "France, food, fun, enjoy">
	<meta name = "description" content = "Tip and tricks about vacation in France">
...
<body>
	...
	<?php if (isset($_POST["addComm"])){
		if (isset($_COOKIE["user"]) || isset($_SESSION["user"]) || isset($_SESSION["userID"]) || isset($_COOKIE["userID"])){
			...
			echo "<a href = 'france_logIn.php' class = 'logIn' >LogIn</a>";
			echo "<a href = 'france_signUp.php' class = 'logIn'>SignUp</a><br>";
		}
	}
	 ?>
	</section>
