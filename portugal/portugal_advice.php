<?php
	include_once "includes/portugal_advice_script.php";
?>
<!DOCTYPE html>
<html lang = "en">
<head>
	...
	<link rel = "stylesheet" href = "../css/style_portugal.css">
	<link rel = "icon" type = "image/icon" href = "../icon1.png">
	
	<meta charset = "UTF-8">
	<meta name = "keywords" content = "Portugal, food, fun, enjoy">
	<meta name = "description" content = "Tip and tricks about vacation in Portugal">
...
<body>
	...
	<nav class = "nav">
		<ul>
			...
			<li> <a href = "portugal_monuments.html">Monuments </a></li>
			<li> <a href = "portugal_food.html">Food </a></li>
			<li> <a href = "portugal_trip.html" >Trip plan </a></li>
			<li><a href = "portugal_advice.php" class = "active"> Advice </a></li>
	...
	<?php if (isset($_POST["addComm"])){
		if (isset($_COOKIE["user"]) || isset($_SESSION["user"]) || isset($_SESSION["userID"]) || isset($_COOKIE["userID"])){
			...
			echo "<a href = 'portugal_logIn.php' class = 'logIn' >LogIn</a>";
			echo "<a href = 'portugal_signUp.php' class = 'logIn' >SignUp</a><br>";
		}
	}
	 ?>
	</section>
