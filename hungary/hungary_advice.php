<?php
	include_once "includes/hungary_advice_script.php";
?>
<!DOCTYPE html>
<html lang = "en">
<head>
	...
	<meta charset = "UTF-8">
	<meta name = "keywords" content = "Hungary, food, fun, enjoy">
...
<body>
	...
	<nav class = "nav">
		<ul>
			...
			<li><a href = "hungary_advice.php" class = "active"> Advice </a></li>
	...
	<?php if (isset($_POST["addComm"])){
		if (isset($_COOKIE["user"]) || isset($_SESSION["user"]) || isset($_SESSION["userID"]) || isset($_COOKIE["userID"])){
			...
			echo "<a href = 'hungary_logIn.php' class = 'logIn' >LogIn</a>";
			echo "<a href = 'hungary_signUp.php' class = 'logIn' >SignUp</a><br>";
		}
	}
	 ?>
	</section>
