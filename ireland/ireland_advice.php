<?php
	include_once "includes/ireland_advice_script.php";
?>
<!DOCTYPE html>
<html lang = "en">
<head>
	...
	<link rel = "stylesheet" href = "../css/style_ireland.css">
	<link rel = "icon" type = "image/icon" href = "../icon1.png">
	
	<meta charset = "UTF-8">
	<meta name = "keywords" content = "Ireland, food, fun, enjoy">
	<meta name = "description" content = "Tip and tricks about vacation in Ireland">
...
<body>
	...
	<nav class = "nav">
		<ul>
			...
			<li> <a href = "ireland_monuments.html">Monuments </a></li>
			<li> <a href = "ireland_food.html">Food </a></li>
			<li> <a href = "ireland_trip.html">Trip plan </a></li>
			<li><a href = "ireland_advice.php" class = "active"> Advice </a></li>
	...
	<?php if (isset($_POST["addComm"])){
		if (isset($_COOKIE["user"]) || isset($_SESSION["user"]) || isset($_SESSION["userID"]) || isset($_COOKIE["userID"])){
			...
			echo "<a href = 'ireland_logIn.php' class = 'logIn' >LogIn</a>";
			echo "<a href = 'ireland_signUp.php' class = 'logIn' >SignUp</a><br>";
		}
	}
	 ?>
	</section>
