<?php
	include_once "includes/bosnia_advice_script.php";
?>
<!DOCTYPE html>
<html lang = "en">
...
<head>
	...
	<meta charset = "UTF-8">
	<meta name = "keywords" content = "Bosnia, Herzegovina, food, fun, enjoy">
	<meta name = "description" content = "Tip and tricks about vacation in B&H">
...
<body>
	...
	<nav class = "nav">
		<ul>
			...
			<li><a href = "bosnia_advice.php" class = "active"> Advice </a></li>
	...
	<?php if (isset($_POST["addComm"])){
		if (isset($_COOKIE["user"]) || isset($_SESSION["user"]) || isset($_SESSION["userID"]) || isset($_COOKIE["userID"])){
			...
			echo "<a href = 'bosnia_logIn.php' class = 'logIn' >LogIn</a>";
			echo "<a href = 'bosnia_signUp.php' class = 'logIn'>SignUp</a><br>";
		}
	}
	 ?>
	</section>
