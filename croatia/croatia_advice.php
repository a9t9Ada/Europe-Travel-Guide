<?php
	include_once "includes/croatia_advice_script.php";
?>
<!DOCTYPE html>
<html lang = "en">
...
<head>
	...
	<link rel = "stylesheet" href = "../css/style_croatia.css">
	<link rel = "icon" type = "image/icon" href = "../icon1.png">
	
	<meta charset = "UTF-8">
	<meta name = "keywords" content = "Croatia, food, fun, enjoy">
	<meta name = "description" content = "Tip and tricks about vacation in Croatia">
...
<body>
	<header class = "header header_image">
		 <img src="images_croatia/croatia_flag.png" alt="Croatia Flag">
	...
	<nav class = "nav">
		<ul>
			...
			<li> <a href = "croatia_monuments.html">Monuments </a></li>
			<li> <a href = "croatia_food.html">Food </a></li>
			<li> <a href = "croatia_trip.html" >Trip plan </a></li>
			<li><a href = "croatia_advice.php" class = "active"> Advice </a></li>
	...
	<?php if (isset($_POST["addComm"])){
		if (isset($_COOKIE["user"]) || isset($_SESSION["user"]) || isset($_SESSION["userID"]) || isset($_COOKIE["userID"])){
			...
			echo "<a href = 'croatia_logIn.php' class = 'logIn' >LogIn</a>";
			echo "<a href = 'croatia_signUp.php' class = 'logIn' >SignUp</a><br>";
		}
	}
	 ?>
	</section>
