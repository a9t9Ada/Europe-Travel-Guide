<?php
	include_once "includes/estonia_advice_script.php";
?>
<!DOCTYPE html>
<html lang = "en">
...
<head>
	...
	<link rel = "stylesheet" href = "../css/style_estonia.css">
	<link rel = "icon" type = "image/icon" href = "../icon1.png">
	
	<meta charset = "UTF-8">
	<meta name = "keywords" content = "Estonia, food, fun, enjoy">
	<meta name = "description" content = "Tip and tricks about vacation in Estonia">
...
<body>
	<header class = "header header_image">
		 <img src="images_estonia/estonia_flag.jpg" alt="Estonia Flag">
	...
	<nav class = "nav">
		<ul>
			...
			<li> <a href = "estonia_monuments.html">Monuments </a></li>
			<li> <a href = "estonia_food.html">Food </a></li>
			<li> <a href = "estonia_trip.html" >Trip plan </a></li>
			<li><a href = "estonia_advice.php"class = "active"> Advice </a></li>
	...
	<?php if (isset($_POST["addComm"])){
		if (isset($_COOKIE["user"]) || isset($_SESSION["user"]) || isset($_SESSION["userID"]) || isset($_COOKIE["userID"])){
			...
			echo "<a href = 'estonia_logIn.php' class = 'logIn'>LogIn</a>";
			echo "<a href = 'estonia_signUp.php' class = 'logIn'>SignUp</a><br>";
		}
	}
	 ?>
	</section>
